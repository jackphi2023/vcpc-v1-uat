...
(function(){
  ...
  var TABLES=['profiles','platform_user_roles','organizations','organization_members','engagements','dashboard_instances','dashboard_versions','dashboard_user_access','data_uploads','data_sources','data_mappings','metric_catalog','org_metric_config','metric_observations','formula_definitions','recommendation_templates','recommendation_rules','impact_records','execution_tasks','alert_rules','dataset_versions','validation_issues','payments','invoice_requests','promo_codes','coupon_redemptions','affiliate_applications','affiliates','affiliate_referrals','affiliate_commissions','affiliate_payouts','tenant_domains','audit_logs','review_tasks','recommendations','alert_events','mi_items','mi_rules','mi_sources','mi_signals','mi_weekly_reports'];
